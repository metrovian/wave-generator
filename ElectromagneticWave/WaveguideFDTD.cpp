...
{
    WaveField init = generateHuygensSource(_mode, _lenx, _leny, _numx, _numy, _lenx / 6.0, _leny / 2.0, 0.0, 1.0, 1.0E+8);
    ...
    for (size_t i = 0; i < numt; ++i)
    {
        ...
        WaveField source = generateHuygensSource(_mode, _lenx, _leny, _numx, _numy, _lenx / 6.0, _leny / 2.0, (double)i * dt, 1.0, 1.0E+8);
